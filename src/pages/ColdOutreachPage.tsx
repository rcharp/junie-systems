...
const nodes = {
  ...
  pitch: {
    ...
    messages: [
      ...
      { label: "If they have NO website:", text: "whats up, my name is ricky. i know this is random, and if a waste of your time just tell me to kick rocks. but i noticed yall dont have a website why probably means people are calling your competitors so i went ahead and built one for you. love to know what you think" }
    ],
    branches: [
