...
const DemoPage = () => {
  useEffect(() => {
    ...
    pixelScript.innerHTML = `
      ...
      fbq('init', '873764708820175');
      fbq('track', 'PageView');
    `;
    document.head.appendChild(pixelScript);

    const noscript = document.createElement("noscript");
    noscript.innerHTML = `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=873764708820175&ev=PageView&noscript=1" />`;
