      ...
      <div className="container mx-auto px-4 py-3 sm:py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          {showAuthButtons && user && isAdmin && (
            <Badge 
              className="bg-blue-600 hover:bg-blue-700 text-white border-0 text-sm sm:text-base px-3 sm:px-4 py-1 sm:py-1.5 flex items-center gap-1.5 sm:gap-2 font-semibold shadow-md cursor-pointer transition-all"
