...
Photos: [25-50 photos uploaded separately - replace existing imagery throughout the site with these new photos in appropriate locations]. These photos will be attached separately, and will be used for the gallery and the "See Us In Action" section. These should be compressed, optimized, and cropped appropriately. If you can identify before and after photos of completed work, create before and after sliders on both the homepage as well as in the image gallery. Also, update the stock photos in the services section on the homepage to relevant photos that have been uploaded. If none can be found, use stock photos relevant to the industry. Important: DO NOT USE AI GENERATED IMAGES. Use actual stock photos from Pexels or Pixabay or Unsplash. IMPORTANT: If NO photos are provided/attached for this business, HIDE the "Gallery" link in the navbar (remove it entirely) AND HIDE the "See Us In Action" section on the homepage (do not render it at all). Do not substitute stock photos for the gallery or "See Us In Action" section — only remove them when no business photos are supplied.
...
If any chosen photo is low resolution or low quality, upscale it to at least 1600px width / 4K resolution while preserving the original aspect ratio so it looks crisp as a full-width background. If NO photos are supplied at all (or not enough appropriate photos are supplied), fall back to pulling industry-appropriate stock photos from the matching folder in the connected Google Drive (e.g. for a junk removal business, use the "Junk Removal Stock Photos" folder; for other industries, use the equivalent industry-named stock photos folder in Google Drive). Only if no matching Google Drive folder exists, fall back to unique, industry-relevant stock photos from Pexels, Pixabay, or Unsplash (no AI-generated images).

Site content:
CRITICAL — Industry alignment: The Company Industry for this business is "${v(promptForm.industry, '[Industry]')}". ALL content across the entire site MUST be specifically tailored to and match this industry. This includes (but is not limited to): every H1/H2/H3 header, every paragraph, subtext and subheaders, hero copy, trust bar items, about us, services descriptions, service areas copy, FAQs, CTAs, testimonials, blog posts and blog titles, SEO metadata (page titles, meta descriptions, meta keywords, Open Graph tags, Twitter card tags, JSON-LD structured data), image alt text, sitemap entries, and any other copy on the site. Do NOT leave any generic or off-industry language anywhere — every piece of content must clearly read as written for a ${v(promptForm.industry, '[Industry]')} business. Create a sitemap file.
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold">Step 5 - Optimizing Customer's Google Business Page</h3>
                  <div className="relative" style={{ paddingBottom: '56.25%', height: 0 }}>
                    <iframe
                      src="https://www.loom.com/embed/d4ae3c1a759d4dfbb84eda0da9fca277"
                      frameBorder={0}
                      allowFullScreen
                      className="absolute top-0 left-0 w-full h-full rounded-md"
                      title="Step 5 - Optimizing Customer's Google Business Page"
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  <h3 className="text-sm font-semibold">Step 6 - How to Set Up a Customer Chat Widget</h3>
                  <div className="relative" style={{ paddingBottom: '56.25%', height: 0 }}>
                    <iframe
                      ...
                      allowFullScreen
                      className="absolute top-0 left-0 w-full h-full rounded-md"
                      title="Step 6 - How to Set Up a Customer Chat Widget"
                    />
                  </div>
                </div>
              </div>
